...
class OrtuPolicy
{
    ...
    {
        return $user->can('delete_any_ortu');
    }
     ...
     */
    public function replicate(User $user, Ortu $ortu): bool
    {
